...
@add_arg_table s begin
    "--params_file"
        ...
        required = true
    "--theta_index"
        help = "Zero-based index of the theta value to use"
        arg_type = Int
        required = true
end
...
zeeman = effective_zeeman_field(h, Z_LOCAL, LOCAL_INTERACTIONS, delta_12, disorder_strength, N_sites, disorder_seed)
